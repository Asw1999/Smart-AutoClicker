...
@DrawableRes
internal fun getPlayRecordingIconRes(): Int =
    R.drawable.ic_recording

internal fun PlayRecording.getDescription(context: Context, inError: Boolean): String = when {
    inError -> context.getString(R.string.item_error_action_invalid_generic)
    else -> "${replaySpeed}x • ${replayRepeat}x"
}
